...
<script>
function formCheck() {
	var banner_name = document.addAdForm.banner_name;
	var banner_division_num = document.addAdForm.banner_division_num;
	var banner_url = document.addAdForm.banner_url;
	var banner_start_day = document.addAdForm.banner_start_day;
	var banner_end_day = document.addAdForm.banner_end_day;
 	var banner_image_url = document.addAdForm.banner_image_url;
	
	if (banner_name.value == "") {
		alert("등록할 배너명을 입력해 주세요.");
		return false;
	};
	
	if (banner_division_num.value == "") {
		alert("배너 위치를 선택해 주세요.");
		return false;
	};
	
	if (banner_url.value == "") {
		alert("등록할 배너의 URL을 입력해 주세요.");
		return false;
	};
		
	if (banner_start_day.value == "") {
		alert("등록할 배너의 시작일을 선택해 주세요.");
		return false;
	};
	
	if (banner_end_day.value == "") {
		alert("등록할 배너의 종료일을 선택해 주세요.");
		return false;
	};
	
	if (banner_image_url.value == "") {
			...
			<div id="content" class="span9">
				...
				<div class="row-fluid">
					<div class="box alternate">
						...
						<form id="addAdForm" class="form-horizontal" method="post" action="AddAd.action" name="addAdForm" enctype="multipart/form-data" onsubmit="return formCheck();">
							<div class="control-group">
							<label class="control-label">배너명</label>
							<div class="controls">
							<input id="banner_name" type="text" name="bb.banner_name">
							</div>
							</div>
							
							<div class="control-group">
								<label class="control-label">배너 위치</label>
								<div class="controls">
								<select id="banner_division_num" name="bb.banner_division_num">
							...
							<div class="controls">
							<input id="banner_url" type="text" name="bb.banner_url">
							</div>
							</div>
							...
							<div class="controls">
							<input id="banner_start_day" type="text" name="bb.banner_start_day" class="datepicker">
							</div>
							</div>
							...
							<div class="controls">
							<input id="banner_end_day" type="text" name="bb.banner_end_day" class="datepicker">
							</div>
							</div>
							...
							<a href="/9-Tails/AdminAD.action" class="btn">취소</a>
							</div>
						</form>
					</div>
				</div> 
